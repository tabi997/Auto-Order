...
import { listingSchema, ListingFormData, ListingWithImages } from '@/types/admin'
...
export function EditListingForm({ listing }: EditListingFormProps) {
  ...
  const form = useForm<ListingFormData>({
    ...
    defaultValues: {
      ...
      gearbox: listing.gearbox as any,
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Editare vehicul: {listing.title}</CardTitle>
      </CardHeader>
      <CardContent>
